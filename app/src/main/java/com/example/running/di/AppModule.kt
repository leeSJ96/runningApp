...
import com.example.running.di.other.Constants.KEY_FIRST_TIME_TOGGLE
import com.example.running.di.other.Constants.KEY_NAME
import com.example.running.di.other.Constants.KEY_WEIGHT
import com.example.running.di.other.Constants.RUNNING_DATABASE_NAME
import com.example.running.di.other.Constants.SHARED_PREFERENCES_NAME
